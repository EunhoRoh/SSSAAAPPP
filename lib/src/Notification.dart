                        ...
                        children: [
                          ...
                          SizedBox(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  Meeting meeting = notify.setGroupPendingTime(
                                      notify.notificationInfo.Group[index]);
                          ...
                          SizedBox(
                              ...
                              child: ListView.builder(
                                padding: const EdgeInsets.all(8),
                                itemCount:
                                    notify.notificationInfo.Friend.length,
                                itemBuilder: (BuildContext context, int index) {
                                  groupProvider.searchUser(
                                      notify.notificationInfo.Friend[index]);
                                  // print("user: ${notify.notificationInfo.Friend[index]}");
                                  return SizedBox(
                                    height: 50,
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        ElevatedButton(
                                          ...
                                          style: ElevatedButton.styleFrom(
                                              primary: Color(0xffB9C98C)),
                                          onPressed: () async {
                                            friendProvider.addFriend(notify
                                                .notificationInfo
                                                .Friend[index]);
